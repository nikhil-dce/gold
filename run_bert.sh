python main.py --task star --version baseline --learning-rate 1e-5 --model bert --n-epochs 25 --do-train --do-save
python main.py --task flow --version baseline --learning-rate 3e-5 --model bert --n-epochs 25 --do-train --do-save
python main.py --task rostd --version baseline --learning-rate 1e-5 --model bert --n-epochs 25 --do-train --do-save
